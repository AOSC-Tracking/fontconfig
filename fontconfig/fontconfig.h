...
#define FC_WIDTH_ULTRACONDENSED	    50.0
#define FC_WIDTH_EXTRACONDENSED	    62.5
#define FC_WIDTH_CONDENSED	    75.0
#define FC_WIDTH_SEMICONDENSED	    87.5
#define FC_WIDTH_NORMAL		    100.0
#define FC_WIDTH_SEMIEXPANDED	    112.5
#define FC_WIDTH_EXPANDED	    125.0
#define FC_WIDTH_EXTRAEXPANDED	    150.0
#define FC_WIDTH_ULTRAEXPANDED	    200.0
